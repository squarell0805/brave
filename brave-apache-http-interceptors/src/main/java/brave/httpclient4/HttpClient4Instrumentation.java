...
public final class HttpClient4Instrumentation {
  ...
  public static HttpClient4Instrumentation create(Tracer tracer) {
  ...
  public static final class Builder {
    ...
    public HttpClient4Instrumentation build() {
      return new HttpClient4Instrumentation(this);
    }
  }
  ...
  HttpClient4Instrumentation(Builder b) {
  ...
  public static void main(String... args) throws IOException {
    HttpClient4Instrumentation tracer =
        HttpClient4Instrumentation.create(Tracer.newBuilder().build());
